...
b8 = ax.bar(x8, y8,width=0.1,color = 'none', align='center',  hatch="**",edgecolor='#000000')
...
ax.legend( (b1, b2, b3,b4,b5,b6, b7, b8), ('NAME','GAlign','PALE','REGAL','Isorank','FINAL', 'IONE', 'UniAlign'), fontsize=13, frameon=False, labelspacing=0, borderpad = 0.01,
